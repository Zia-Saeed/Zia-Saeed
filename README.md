...
- Design, deploy, and operate containerized microservices on Amazon ECS across dev, staging, and production
- Built Stage and Production infrastructure from the ground up using Terraform (ECS, RDS, VPC, S3, Secrets Manager, ALB, ElastiCache, EC2, CloudWatch)
- Implemented AWS Security Hub and GuardDuty at the Org level across 7 AWS accounts
- Architected a VPC-based WireGuard VPN for secure, least-privilege database access
- Deployed a production ML model on AWS GPU-backed EC2 instances
- Reduced production and development cloud costs by 50%
- Led a live production region migration (Dubai → Mumbai) during a datacenter outage with zero data loss
- Led a full production migration from Alibaba Cloud to AWS with minimal downtime

**DevOps Engineer — 7 Kings Code**
*Lahore, Pakistan (On-Site) | 09/2024 – 12/2025*
- Automated CI/CD pipelines with Jenkins for React, Django, Next.js, and Drupal applications, sustaining 99.9% uptime
- Recovered production servers from React/Next.js vulnerability exploits and hardened operations to prevent recurrence
- Migrated WordPress, React, Next.js, and Django applications with zero downtime on AWS (Kubernetes, PostgreSQL, MariaDB)
- Implemented Prometheus, Grafana, and Uptime Kuma for monitoring and alerting
- Integrated SonarQube and Trivy into CI/CD pipelines for security-shifted-left delivery
